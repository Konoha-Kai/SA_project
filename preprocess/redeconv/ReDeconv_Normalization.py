...
# ------ Input file name
fn_meta = r'/home/shanggk/SC_data/UMI_sc_gene/sc_meta.tsv'
fn_exp = r'/home/shanggk/SC_data/UMI_sc_gene/gene_expression.tsv'

# ------ Output file names for cell type count and mean information
fn_ctyp_mean = './UMI_sc_gene/Ctype_size_means.tsv'
fn_ctyp_count = './UMI_sc_gene/Ctype_cell_counts.tsv'
fn_cell_transcriptome_size = './UMI_sc_gene/Cell_trans_sizes.tsv'
...
if choice == 2:
    ...
    # ------ output file names
    fn_heatmap = './UMI_sc_gene/picture/Heatmap_plot.png'
    fn_heatmap_matrix = './UMI_sc_gene/picture/Heatmap_plot_correlation_matrix.csv'
...
if choice == 3:
    ...
    # ------ output file names
    fn_extra_info = './UMI_sc_gene/picture/Extra_information.txt'
    fn_point = './UMI_sc_gene/picture/Points_plot.png'

    # ----
    L_figureNo_eachRow = 6
    L_baseline = 5
    L_Pearson_LB = 0.95
...
if choice == 4:
    ...
    fn_meta_2 = './UMI_sc_gene/re-20-base-5-generate/Meta_data_new.tsv'

    # File name for scRNA-seq data submatrix for chosen cells. This file will not be created if all cells are chosen.
    fn_exp_2 = './UMI_sc_gene/re-20-base-5-generate/scRNA_seq_temp_file.tsv'

    # File name for normalized scRNA-seq data; no shift.
    fn_exp_3 = './UMI_sc_gene/re-20-base-5-generate/scRNA_seq_new_noShift.tsv'

    # File name for normalized scRNA-seq data; with shift
    fn_exp_4 = './UMI_sc_gene/re-20-base-5-generate/scRNA_seq_new_withShift.tsv'
